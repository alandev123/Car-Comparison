...
<body class="cbp-spmenu-push">
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
		...
		<?php
					...
					<?php
						$tu="select username from login_tb where utype='user'";
						$result1=mysql_query($tu,$con);
						$rowcount1=mysql_num_rows($result1);
											?>
						<?php
						$tu2="select username from login_tb where utype='company'";
						$result2=mysql_query($tu2,$con);
						$rowcount2=mysql_num_rows($result2);
						?>

						<?php
						$tu5="select username from login_tb where utype='blockedcompany'";
						$result5=mysql_query($tu5,$con);
		...
		<div id="page-wrapper">
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong><?php echo $rowcount3 ?></strong></h5>
                      <span>Cars to Compare</span>
                    </div>
                </div>
        	</div>
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong><?php echo $rowcount2 ?></strong></h5>
                      <span>Companies</span>
                    </div>
                </div>
        	</div>
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    <i class="pull-left fa fa-money user2 icon-rounded"></i>
                    <div class="stats">
                      <h5><strong><?php echo $rowcount ?></strong></h5>
        	...
        	<div class="col-md-3 widget">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong><?php echo $rowcount1 ?></strong></h5>
	...
	<br/>
<?php
$result = mysql_query("SELECT mid,cname,address,state,city,pin,contact,cin,email,username,status FROM mreg_tb where status='pending'");
...
{ 
echo "<form action='maproveaction.php' method='post'>";
echo "<tr>";
echo "<td align='center'>" . $row['mid'] . "</td>";
...
echo "<td align='center'>" . $row['cin'] . "</td>";
echo "<td align='center'>" . $row['email'] . "</td>";
echo "<td align='center'>" . $row['username'] . "</td>";
echo "<td align='center'>" . $row['status'] . "</td>";
	echo "<input type='hidden' name='username' value=".$row['username'].">";
	echo "<input type='hidden' name='mid' value=".$row['mid'].">";
echo '<td><button class="btn btn-primary" name="passed">Aprove</button></td>';
echo "</tr>";
echo "</form>";
}
echo "</table>";
