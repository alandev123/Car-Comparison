	...
	<aside class="sidebar trans-0-4">
		...
		<ul class="menu-sidebar p-t-95 p-b-70">
			...
			<li class="t-center m-b-13">
				<a href="viewcar" class="txt19">Cars</a>
			</li>
			<li class="t-center m-b-13">
				<a href="cmpr.php" class="txt19">compare cars</a>
			</li>
			<li class="t-center m-b-13">
...
<div>
<div >
				<center><h3 style="font-family: TimesNewRoman;">Wheelie</h3></center>
<br/>
<br/>
<br/>

				<center><h5 style="font-family: TimesNewRoman;">Wheelie is a website service to compare cars with their specification. Established since 2018</h5></center>
	<br/>
	<br/>
	<br/>
	<br/>
