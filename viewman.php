...
<body class="cbp-spmenu-push">
	...
	<br/>
<?php
$result = mysql_query("SELECT * FROM mreg_tb ");
...
{ 
echo "<form action='blockman.php' method='post'>";
echo "<tr>";
...
echo '<td><button class="btn btn-primary" name="unblocking">Unblock</button></td>';
	}
	else{
		echo '<td><button class="btn btn-primary" name="passed">Block</button></td>';
	}
echo "</tr>";
echo "</form>";
}
