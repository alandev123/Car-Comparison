...
-->						</a>
	...
	<section class="bg-title-page flex-c-m p-t-160 p-b-80 p-l-15 p-r-15" style="background-image: url(pics/nissan1.jpg);">
...
<h2 class="tit6 t-center">
			...
			<form action="locaction.php" class="wrap-form-booking" method="post" enctype="multipart/form-data">
					...
					<div class="col-12">
						...
						<textarea class="bo-rad-10 size35 bo2 txt10 p-l-20 p-t-15 m-b-10	 m-t-3" name="notification" placeholder="Your Message"></textarea>
					</div>
							<!-- Button3 -->
