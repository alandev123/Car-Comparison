	...
	<header>
		...
		<div class="container">
			<h3 class="tit7 t-center p-b-62 p-t-105">
				Signup Here as a manufacture  </h3>

			<form id="mregForm" action="mregaction.php" method="post" class="wrap-form-reservation size22 m-l-r-auto" >

				<center>
					<div class="row">
						<div class="col-md-5 text-right pt-3"><b>Comapny Name</b></div>
						<div class="col-md-4" style="display: inline-block">
						<div class="wrap-inputname size12 bo2 bo-rad-10 m-t-3 m-b-23">
						<input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="cname" placeholder="Comapny Name" id="cname" required>
						</div>
						</div>
					</div>
					<br/>
					...
					<div class="row">
						<div class="col-md-5 text-right pt-3"><b>Address line 1</b></div>
						<div class="col-md-4" style="display: inline-block">
						<div class="wrap-inputname size12 bo2 bo-rad-10 m-t-3 m-b-23">
						<input class="bo-rad-10 sizefull txt10 p-l-20"  name="address" placeholder="Address" id="address" required>
						</div>
						</div>
					</div>
					<br/>
					...
					<!--    ......     -->
						<div class="row">
						<div class="col-md-5 text-right pt-3"><b>Pin code</b></div>
						<div class="col-md-4" style="display: inline-block" style>
						<div class="wrap-inputname size12 bo2 bo-rad-10 m-t-3 m-b-23">
						<input class="bo-rad-10 sizefull txt10 p-l-20" type="number" name="pin" placeholder="Pin code" id="pin" required>
						</div>
						</div>
					</div>
					<br/>
					...
					<div class="row">
						...
						<div class="col-md-4" style="display: inline-block" style>
						<div class="wrap-inputname size12 bo2 bo-rad-10 m-t-3 m-b-23">
						<input class="bo-rad-10 sizefull txt10 p-l-20" type="number" name="contact" placeholder="Contact Number" id="contact" pattern="[6-9]{1}[0-9]{9}" required>
						</div>
						</div>
					</div>
					<br/>
					<!--    ......     -->
						<div class="row">
						<div class="col-md-5 text-right pt-3"><b>CIN</b></div>
						<div class="col-md-4" style="display: inline-block" style>
						<div class="wrap-inputname size12 bo2 bo-rad-10 m-t-3 m-b-23">
						<input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="cin" placeholder="Corporate Identity Number" id="cin" required>
						</div>
						</div>
					</div>
					<br/>
					...
					<div class="row">
						...
						<div class="col-md-4" style="display: inline-block">
						<div class="wrap-inputname size12 bo2 bo-rad-10 m-t-3 m-b-23">
						<input class="bo-rad-10 sizefull txt10 p-l-20" type="password" name="password" placeholder="Password" id="password" required>
						</div>
						</div>
					</div>
					<br/>
			  ...
			  <div class="row p-t-135">
				...
				<?php /*?><div class="col-sm-8 col-md-5 col-lg-4 m-l-r-auto p-t-30">
					<div class="dis-flex m-l-23">
						<div class="p-r-40 p-t-6">
