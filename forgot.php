...
<h2 class="tit6 t-center">
			...
			<form action="forgot2.php" method="post" class="wrap-form-reservation size22 m-l-r-auto" autocomplete="off">
              ...
              <span class="txt9">
                Enter Your Username
						...
						<div class="wrap-inputname size12 bo2 bo-rad-10 m-t-3 m-b-23">
							<input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="u_name" placeholder="Enter Your Username" required>
						</div>
					</div>
