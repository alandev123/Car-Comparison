...
<div >
  ...
  <form action="mupdate.php" class="wrap-form-booking" method="post" enctype="multipart/form-data">
...
$prof=mysql_query("SELECT * from `mreg_tb` WHERE username='$uname'",$con);
...
?>
  ...
  <div class="wrap-inputvarient size12 bo2 bo-rad-10 m-t-3 m-b-23">
    ...
    <input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="id" id="id" value="<?php echo $id ?>" disabled>
  </div>
  <!-- fuel -->
  <span class="txt9">
    Name
  ...
  <div class="wrap-inputphone size12 bo2 bo-rad-10 m-t-3 m-b-23">
    <input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="cname" id="cname" value="<?php echo $cname ?>" disabled>
  </div>
  ...
  <div class="wrap-inputname size12 bo2 bo-rad-10 m-t-3 m-b-23">
    <input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="address" id="address" value="<?php echo $address ?>" disabled>
  </div>
  ...
  <div class="wrap-inputemail size12 bo2 bo-rad-10 m-t-3 m-b-23">
    <input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="state" id="state" value="<?php echo $state ?>" disabled>
  </div>
  <span class="txt9">
    City
  </span>
  ...
  <div class="wrap-inputemail size12 bo2 bo-rad-10 m-t-3 m-b-23">
    <input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="city" id="city" value="<?php echo $city ?>" disabled>
  </div>
  ...
  <div class="wrap-inputemail size12 bo2 bo-rad-10 m-t-3 m-b-23">
    <input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="pin" id="pin" value="<?php echo $pin ?>" disabled>
  </div>
</div>
  <div class="col-md-4">
  <span class="txt9">
  ...
  <div class="wrap-inputemail size12 bo2 bo-rad-10 m-t-3 m-b-23">
    <input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="contact" id="contact" value="<?php echo $contact ?>" disabled>
  </div>
  ...
  <div class="wrap-inputemail size12 bo2 bo-rad-10 m-t-3 m-b-23">
    <input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="cin" id="cin" value="<?php echo $cin ?>" disabled>
  </div>
	...
	<div class="wrap-inputemail size12 bo2 bo-rad-10 m-t-3 m-b-23">
		<input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="email" id="email" value="<?php echo $email ?>" disabled>
	</div>
	<span class="txt9">
	Username
	</span>
	...
	<div class="wrap-inputemail size12 bo2 bo-rad-10 m-t-3 m-b-23">
		<input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="password" id="password" value="<?php echo $password ?>" disabled>
	</div>
