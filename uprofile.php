...
<body class="animsition">
	...
	<aside class="sidebar trans-0-4">
		...
		<ul class="menu-sidebar p-t-95 p-b-70">
			...
			<li class="t-center m-b-13">
				<a href="uviewcars" class="txt19">Cars</a>
			</li>
...
<div >
  ...
  <form action="updateudet.php" class="wrap-form-booking" method="post" enctype="multipart/form-data">
...
?>
  ...
  <div class="wrap-inputvarient size12 bo2 bo-rad-10 m-t-3 m-b-23">
    ...
    <input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="name" id="name" value="<?php echo $name ?>" disabled>
  </div>
  <!-- fuel -->
  <span class="txt9">
    State
