...
<h2 class="tit6 t-center">
			...
			<form action="loginaction.php" method="post" class="wrap-form-reservation size22 m-l-r-auto" autocomplete="off">
				...
				<center>
					<div class="col-md-4">
						...
						<div class="wrap-inputname size12 bo2 bo-rad-10 m-t-3 m-b-23">
							<input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="u_id" placeholder="Username" required autofocus>
						</div>
					</div>
			...
			<div>
				...
				<div>
					<a href="ureg.php"  style="font-family: Times New Roman; color: aliceblue"><h4>Not a user Click here to register</h4></a>
				</div>
				</center>
			</form>
