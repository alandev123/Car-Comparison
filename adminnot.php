...
<h2 class="tit9 t-center">
			Notification
			<br/>
		</h2>

			<form action="notaction.php" class="wrap-form-booking" method="post" enctype="multipart/form-data">
					...
					<div class="col-12">
						...
						<textarea class="bo-rad-10 size35 bo2 txt10 p-l-20 p-t-15 m-b-10	 m-t-3" name="msg" placeholder="Message"></textarea>
					</div>
							<!-- Button3 -->
