...
<body class="animsition">
	...
	<aside class="sidebar trans-0-4">
		...
		<ul class="menu-sidebar p-t-95 p-b-70">
			...
			<li class="t-center m-b-13">
				<a href="viewcar.php" class="txt19">Cars</a>
			</li>

			<li class="t-center m-b-13">
				<a href="cmpr.php" class="txt19">compare</a>
			</li>

			<li class="t-center m-b-13">
				<a href="aboutus1.php" class="txt19">About</a>
			</li>
			...
			<li class="t-center">
				<!-- Button3 -->
				<a href="cmpr.php" class="btn3 flex-c-m size13 txt11 trans-0-4 m-l-r-auto">
					Compare cars
				</a>
			</li>
		</ul>
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				...
				<div class="item-slick1 item2-slick1" style="background-image: url(pics/nissan1.jpg);">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
				...
				<div class="item-slick1 item3-slick1" style="background-image: url(pics/benz.jpg);">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
	...
	<!-- Our menu -->
	<?php /*?><section class="section-ourmenu bg2-pattern p-t-115 p-b-120">
		<div class="container">
	...
	<!-- Event -->
	<?php /*?><section class="section-event">
...
<?php /*?>	<!-- Booking -->
	...
	<!-- Review -->
	<?php /*?><section class="section-review p-t-115">
		<!-- - -->
				...
				<div class="col-sm-6 col-md-4 p-t-50">
					...
					<div>
						...
						<p class="txt14 m-b-18">
							Yaris is a Good option as a sedan
							<br/>
							<a href="#" class="txt15">
