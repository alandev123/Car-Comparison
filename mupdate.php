...
<div >
  ...
  <form action="mupdateaction.php" class="wrap-form-booking" method="post" enctype="multipart/form-data">
...
?>
  ...
  <div class="wrap-inputphone size12 bo2 bo-rad-10 m-t-3 m-b-23">
    <input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="cname" id="cname" value="<?php echo $cname ?>">
  </div>
  ...
  <div class="wrap-inputname size12 bo2 bo-rad-10 m-t-3 m-b-23">
    <input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="address" id="address" value="<?php echo $address ?>">
  </div>
  ...
  <div class="wrap-inputemail size12 bo2 bo-rad-10 m-t-3 m-b-23">
    <input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="pin" id="pin" value="<?php echo $pin ?>">
  </div>
</div>
  <div class="col-md-4">
  <span class="txt9">
